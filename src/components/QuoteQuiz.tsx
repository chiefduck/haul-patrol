...
import { Check, ArrowRight, ArrowLeft, Sofa, Trash2, Home, Building2, Leaf, Package } from "lucide-react";
...
const QuoteQuiz = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-background via-accent/5 to-background" id="quote-quiz">
          ...
          <Card className="p-8 md:p-12 shadow-elevated">
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm text-muted-foreground">{step === 1 ? '50%' : '100%'}</span>
              </div>
                    ...
                    return (
                      ...
                      >
                        <Icon className={`w-12 h-12 mx-auto mb-3 ${
                          selectedService?.id === service.id ? 'text-accent' : 'text-secondary'
                        }`} />
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div className="grid gap-4">
                  {volumes.map((volume) => (
                    <button
                      ...
                      className={`p-6 rounded-2xl border-2 transition-all hover:scale-102 flex items-center gap-4 ${
                ...
                {/* Estimate Display */}
                {selectedVolume && (
                  <div className="bg-gradient-to-r from-accent to-secondary p-8 rounded-2xl text-white text-center mt-8">
                    ...
                    <Button
                      size="lg"
                      className="bg-white text-primary hover:bg-white/90 text-lg py-6 px-8 font-bold"
